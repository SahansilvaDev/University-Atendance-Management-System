...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $code = $_POST['code'];
    $not_expired = 1;  // Set to 1 for not expired
    $expired = 0;
    ...
    $stmt = $conn->prepare("INSERT INTO qr_codes (code, not_expired, expired) VALUES (?, ?, ?)");
    $stmt->bind_param("sii", $code, $not_expired, $expired);
