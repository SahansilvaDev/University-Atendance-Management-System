...
if (isset($_POST['user_id'], $_POST['password'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        if (password_verify($password, $row['password'])) {
            ...
            $sql_token = "SELECT Token_idinti FROM teacher WHERE user_id = '$user_id'";
            $result_token = $conn->query($sql_token);
            $row_token = $result_token->fetch_assoc();

            if ($row_token['Token_idinti'] == '1') {
                
                header("Location: ../index.php");
                exit();
            } else {
                // Proceed with login
                header("Location: ./checkemail.php?user_id=" . $user_id);
                exit();
            }
        } else {
                            ...
                            <div class="login-container">
                                ...
                                <form action="" method="post">
                                    <div class="input-group">
                                        <input class="form-control form-control" type="text" id="username" name="user_id" required placeholder="User ID">
                                        <div class="input-group-append">
                                            <span class="input-group-text"><svg xmlns="http://www.w3.org/2000/svg" height="16" width="16" viewBox="0 0 512 512"><path d="M48 64C21.5 64 0 85.5 0 112c0 15.1 7.1 29.3 19.2 38.4L236.8 313.6c11.4 8.5 27 8.5 38.4 0L492.8 150.4c12.1-9.1 19.2-23.3 19.2-38.4c0-26.5-21.5-48-48-48H48zM0 176V384c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V176L294.4 339.2c-22.8 17.1-54 17.1-76.8 0L0 176z"/></svg></span>
                                        </div>
                                    </div>
                                    <br>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <span class="input-group-text"><svg xmlns="http://www.w3.org/2000/svg" height="16" width="14" viewBox="0 0 448 512"><path d="M144 144v48H304V144c0-44.2-35.8-80-80-80s-80 35.8-80 80zM80 192V144C80 64.5 144.5 0 224 0s144 64.5 144 144v48h16c35.3 0 64 28.7 64 64V448c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V256c0-35.3 28.7-64 64-64H80z"/></svg></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group form-check pt-3 pb-3">
                                        ...
                                        <div class="row me-1">
                                            ...
                                            <div class="col-sm-6 float-right"><a href="#"><label class="form-check-label" for="exampleCheck1">Forget password</label></a></div>
                                        </div>
                                    </div>
