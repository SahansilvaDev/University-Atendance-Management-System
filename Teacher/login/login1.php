                            ...
                            <div class="login-container mt-5">
                                ...
                                <form action="" method="post">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control form-control" type="text" id="username" name="user_id" required placeholder="U S E R I D">
                                        <div class="input-group-append">
                                            <span class="input-group-text"><svg xmlns="http://www.w3.org/2000/svg" height="16" width="16" viewBox="0 0 512 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <span class="input-group-text"><svg xmlns="http://www.w3.org/2000/svg" height="16" width="14" viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2023 Fonticons, Inc.-->
                                    ...
                                    <div class="form-group form-check pt-3 pb-3">
                                        ...
                                        <div class="row me-1">
                                            <div class="col-sm-5 " style="margin-left:8px;"><label class="form-check-label" for="exampleCheck1">Remember me</label></div>
                                    ...
                                    <button type="submit" class="btn btn-primary btn btn-block mb-1 rounded-pill  sing_in_bold"> s i g n   <span class="mx-1"> </span> I N</button>
                                    <h5 class="text-center py-2">OR</h5>
                                    <button type="submit" class="btn btn-outline-primary btn btn-block g_btn mb-3 rounded-pill"> <img src="./google.png" class="px-2"> Continue With Google </button>
