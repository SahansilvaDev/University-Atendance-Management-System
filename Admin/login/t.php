...
if (isset($_POST['email'], $_POST['password'])) {
    ...
    $password = $conn->real_escape_string($_POST['password']); // Use real_escape_string to prevent SQL injection
    $user_role = 3;
    ...
    header("Location:../../Student/index.php?error=1");
